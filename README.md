# LLM Project
> Tashrif Mahmud
:hugging_face: ["Hugging Face Repo"](https://huggingface.co/tashrifmahmud/sentiment_analysis_model_v2) | ["Streamlit App"]()
...
We also built a ["Streamlit App"]() and details of it can be found in ["app.py"](https://github.com/tashrifmahmud/LLM-Project/blob/main/app.py) script. 
...
> Final Model: ["Model"](https://huggingface.co/tashrifmahmud/sentiment_analysis_model_v2) | ["App"]()
...
## Links
:hugging_face: ["Hugging Face"](https://huggingface.co/tashrifmahmud/sentiment_analysis_model_v2) | ["Streamlit App"]()
